...
public class SQLServerConnectionPool {
	public static Logger log = Logger.getLogger(SQLServerConnectionPool.class);
	 ...
	 * 
	 */
	public SQLServerConnectionPool(String jdbcDriver, String dbUrl,
	...
	public synchronized void createPool() throws Exception {
		...
		log.info("SQL Server connection pool created success!");
	}
	...
	private void createConnections(int numConnections) throws SQLException {
		...
		for (int x = 0; x < numConnections; x++) {
			...
			try {
				...
				log.error("fail in create connection " + e.getMessage());
