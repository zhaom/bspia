...
<div> 
	<table class="basic-table-sh">
		...
		<tr>
			<td colspan="3">
				<form id="editForm" class="submitForm" action="/enterprise/browseProject.action" method="post">
					<table>
						<tr>
  ...
  <s:action name="enterprise!listProject" namespace="/enterprise" executeResult="true" >
