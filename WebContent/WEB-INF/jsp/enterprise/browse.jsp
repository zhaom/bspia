	...
	<table class="basic-table-sh">
		<tr>
			...
			<td align="right">
				<div class="buttonUl">
					<ul>
						<li><a class="submitButton"  href="/enterprise/enterprise!add.action"><s:property value="%{getText('menu_mem_input')}"/></a></li>
		...
		<tr>
			<td colspan="3">
				<form id="editForm" class="submitForm" action="/enterprise/browse.action" method="post">
					<table>
						<tr>
...
<s:action name="enterprise!list" namespace="/enterprise" executeResult="true" >
...
<div class="buttonUl">
	<ul>
		<m:pager curPage="%{#parameters.pno[0]}" totalPage="%{#paging.totalPage}" theme="simple" url="/enterprise/browse.action?pno={page}&requestId=%{#request.encodeRequestId}" pageLimit="10" showTotalPage="false" totalRecord="%{#paging.totalRecord}" showTotalRecord="false" />
	</ul>
</div>
	<%--  
  <div class="buttonUl"><ul><li><a href="/enterprise/enterprise!add.action"><s:property value="%{getText('common_add')}"/>  </a></li></ul></div>
  --%>  