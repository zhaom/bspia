<%@ include file="/WEB-INF/jsp/header.jsp" %>
  ...
  <s:action name="qualificationPaging" id="paging" namespace="/qualification" executeResult="false">
  ...
  <s:action name="qualification!list" namespace="/qualification" executeResult="true" >
  	<s:param name="pno" value="#parameters.pno"/>
    <s:param name="rows" value="10"/>
    <s:param name="requestId" value="#parameters.requestId"/>
  </s:action>

  <div class="buttonUl"><ul><li><a class="submitButton" href="/qualification/qualification!add.action?enterpriseid=<%=request.getParameter("requestId")%>"><s:property value="%{getText('common_add')}"/></a></li></ul></div>