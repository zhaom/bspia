...
<@pagePanel cur=parameters.curPage total=parameters.totalPage url=parameters.url limit=limit />   
<#--打印选择页的面板结束-->   
   
<#--显示总页数-->   
<#if parameters.showTotalPage?exists && (parameters.showTotalPage == true)>   
    <li><span>..${parameters.totalPage}</span><li><#rt/>   
</#if>   
...
<#macro printButton direct valuable = true>   
    <#if direct == "left">   
        <#if valuable>   
            <li><a href="<@makeURL text=parameters.url page=1 />"> << </a></li><#rt/>   
            <li><a href="<@makeURL text=parameters.url page=parameters.curPage-1 />"> < </a></li><#rt/>   
        <#else>   
            <li><span><<</span></li><#rt/>   
            <li><span><</span></li><#rt/>   
        </#if>   
    <#else>   
        <#if valuable>   
            <li><a href="<@makeURL text=parameters.url page=parameters.curPage+1 />"> > </a></li><#rt/>   
            <li><a href="<@makeURL text=parameters.url page=parameters.totalPage />"> >> </a></li><#rt/>   
        <#else>   
            <li><span>></span></li><#rt/>   
            <li><span>>></span></li><#rt/>   
        </#if>   
