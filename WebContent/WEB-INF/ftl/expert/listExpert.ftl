            ...
            <tr>
              ...
              <td>
              	<div class="buttonUl">
              		<ul>
              			<li>
              				<a class="submitButton"  href="/expert/expert!edit.action?requestId=${expert.id}"><@s.text name="common_edit"/> </a>
              			</li>
              			<li>
              				<a class="submitButton"  href="/expert/expert!remove.action?requestId=${expert.id}"><@s.text name="common_delete"/></a>
              			</li>
              			<#if expert.picture?has_content>
              			<#else>
							<li>
								<a  class="submitButton" href="/expert/uploadExpertPicture.action?id=${expert.id?if_exists}"><@s.text name="correspondent_upload_picture"/></a>
							</li>
              			</#if>
              		</ul>
              	</div>
