        ...
        <table class="basic-table-sh">
        	<thead>
        	    <tr>
      				...
      				<th><@s.text name="enterprise_toHighApplyLevelDescripton"/></th>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>${enterprise.toHighApplyLevelDescripton?if_exists}</td>
              ...
              <td><div class="buttonUl"><ul><li><a class="submitButton"  href="/expert/browseExpertProjectFromEnterprise.action?requestId=${enterprise.id}"><@s.text name="menu_Project"/> </a></li>
              </ul></div></td></td>
            </tr>
            </#list>
           </tbody>
