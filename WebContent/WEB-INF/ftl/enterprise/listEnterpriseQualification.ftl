        ...
        <table class="basic-table-sh">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><div class="buttonUl"><ul><li><a class="submitButton"  href="/enterprise/enterprise!editQualification.action?requestId=${enterprise.id}"><@s.text name="enterprise_Qualificationadmin"/> </a></li>
              </ul></div></td></td>
            </tr>
            </#list>
           </tbody>
