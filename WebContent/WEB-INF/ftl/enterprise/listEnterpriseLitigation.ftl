        ...
        <table class="basic-table-sh">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td><div class="buttonUl"><ul><li><a class="submitButton"  href="/finance/browseLitigation.action?requestId=${enterprise.id}"><@s.text name="enterprise_litigationadmin"/> </a></li>
              </ul></div></td></td>
            </tr>
            </#list>
           </tbody>
